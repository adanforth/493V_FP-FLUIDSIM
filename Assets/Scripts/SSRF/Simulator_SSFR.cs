...
public class Simulator_SSFR : MonoBehaviour
{
    ...
    private void UpdateBuffers()
    {
        ...
        _compute.SetFloats("_cameraPos", cam.transform.position.x, cam.transform.position.y, cam.transform.position.z);
        _compute.SetFloat("_clipFar", Vector3.Distance(cam.transform.position, new Vector3(0, _simHeight / 2, 1f * _simDepth)));
    ...
    void Update()
    {
        Graphics.Blit(cam.activeTexture, tex, Mat);
        //Debug.Log(x0);
        //Debug.Log(y0);
        ...
        //_compute.SetFloat("_timeStep", 1f / 200f);
        ...
        //Debug.DrawLine(new Vector3(0, 0, _simDepth + _h / 2), new Vector3(0, _simHeight + _h / 2, _simDepth + _h / 2), Color.gray);
        //Debug.DrawLine(new Vector3(0, 0, _simDepth + _h / 2), new Vector3(_simWidth + 0, 0, _simDepth + _h / 2), Color.gray);
        //Debug.DrawLine(new Vector3(0, _simHeight + _h / 2, _simDepth + _h / 2), new Vector3(_simWidth + 0, _simHeight + _h / 2, _simDepth + _h / 2), Color.gray);
        //Debug.DrawLine(new Vector3(_simWidth + 0, 0, _simDepth + _h / 2), new Vector3(_simWidth + 0, _simHeight + _h / 2, _simDepth + _h / 2), Color.gray);
